...
public class VtnRegistrarConferencia extends javax.swing.JFrame {
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        try {
            ...
            bandera = this.objServicioAlmacenamiento.guardarConferencia(objConferencia, token);
            if (bandera) {
//            NotificationWindow notification = new NotificationWindow("Conferencia creada con éxito");
