package co.edu.unicauca.vistas.conferencia;
...
public class VtnListarConferencias extends javax.swing.JInternalFrame {
    ...
    public VtnListarConferencias(ConferenciaServices objServicioAlmacenamiento){
        try {
            ...
            Logger.getLogger(VtnListarConferencias.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void llenarTabla() throws Exception {
        ...
        limpiarTabla();
        ArrayList<Conferencia> listaConferencias = (ArrayList<Conferencia>) this.objServicioAlmacenamiento.listarConferencias(token);
